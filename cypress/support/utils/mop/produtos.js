const ENTIDADES_CONFIG = {
  ...
  SELECT_CAD_PRODUTO_KIT: {
    ...
    salvarComo: '9 - SELECT_CAD_PRODUTO_KIT',
  },
  SELECT_CAD_PRODUTO_TARIFA: {
    ...
    campoBusca: 'idProduto',
    salvarComo: '10 - SELECT_CAD_PRODUTO_TARIFA',
  },
  SELECT_CAD_PRODUTO_GARANTIA: {
    ...
    campoBusca: 'idProduto',
    salvarComo: '11 - SELECT_CAD_PRODUTO_GARANTIA',
  },
  SELECT_CAD_GARANTIA_CATEGORIA: {
    nomeArquivo: '11 - SELECT_CAD_PRODUTO_GARANTIA',
    campoId: 'idGarantiaCategoria',
    tabela: 'MC_CAD_GARANTIA_CATEGORIA', 
    salvarComo: '12 - SELECT_CAD_GARANTIA_CATEGORIA',
  },
  SELECT_CAD_TARIFA: {
    nomeArquivo: '10 - SELECT_CAD_PRODUTO_TARIFA',
    campoId: 'idTarifa',
    tabela: 'MC_CAD_TARIFA', 
    salvarComo: '13 - SELECT_CAD_TARIFA',
  },
  SELECT_CAD_KIT_DOCUMENTO: {
    nomeArquivo: '9 - SELECT_CAD_PRODUTO_KIT',
    campoId: 'idKitDocumento',
    tabela: 'MC_CAD_KIT_DOCUMENTO', 
    salvarComo: '14 - SELECT_CAD_KIT_DOCUMENTO',
  },
  SELECT_CAD_GARANTIA_CLASSIFICACAO: {
    nomeArquivo: '12 - SELECT_CAD_GARANTIA_CATEGORIA',
    campoId: 'idGarantiaClassificacao',
    tabela: 'MC_CAD_GARANTIA_CLASSIFICACAO', 
    salvarComo: '15 - SELECT_CAD_GARANTIA_CLASSIFICACAO',
  },
  SELECT_CAD_TIPO_GARANTIA: {
    nomeArquivo: '12 - SELECT_CAD_GARANTIA_CATEGORIA',
    campoId: 'idTipoGarantia',
    tabela: 'MC_CAD_TIPO_GARANTIA', 
    salvarComo: '16 - SELECT_CAD_TIPO_GARANTIA',
  },
  SELECT_CAD_GARANTIA_NIVEL: {
    nomeArquivo: '12 - SELECT_CAD_GARANTIA_CATEGORIA',
    campoId: 'idGarantiaNivel',
    tabela: 'MC_CAD_GARANTIA_NIVEL', 
    salvarComo: '17 - SELECT_CAD_GARANTIA_NIVEL',
  },
  SELECT_CAD_GRUPO_GARANTIA: {
    nomeArquivo: '12 - SELECT_CAD_GARANTIA_CATEGORIA',
    campoId: 'idGrupoGarantia',
    tabela: 'MC_CAD_GRUPO_GARANTIA', 
    salvarComo: '18 - SELECT_CAD_GRUPO_GARANTIA',
  },

  CAD_GRUPO_PRODUTO_RISCO: {
    nomeArquivo: '8 - SELECT_GRUPO_PRODUTO',
    campoId: 'idGrupoProdutoRisco',
    tabela: 'MC_CAD_GRUPO_PRODUTO_RISCO', 
    salvarComo: '19 - CAD_GRUPO_PRODUTO_RISCO',
  },
}
